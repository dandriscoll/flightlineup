...
import { Ship, Setup, FormatShip, FormattedShip, isValidIconFilename } from '../../../types';
...
const Tile: React.FC<TileProps> = ({ ship, setup, forOccupant = false }) => {
    const [formattedShip, setFormattedShip] = React.useState<FormattedShip | null>(null);
